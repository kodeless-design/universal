...
describe('Alert', () => {
  ...
  describe('data-api', () => {
    it('should close an alert without instantiating it manually', () => {
      fixtureEl.innerHTML = [
        '<div class="alert">',
        '  <button type="button" data-un-dismiss="alert">x</button>',
        '</div>'
      ].join('')
    ...
    it('should close an alert without instantiating it manually with the parent selector', () => {
      fixtureEl.innerHTML = [
        '<div class="alert">',
        '  <button type="button" data-un-target=".alert" data-un-dismiss="alert">x</button>',
        '</div>'
      ].join('')
  ...
  describe('close', () => {
    it('should close an alert', done => {
      ...
      alertEl.addEventListener('closed.un.alert', () => {
        expect(document.querySelectorAll('.alert').length).toEqual(0)
    ...
    it('should not remove alert if close event is prevented', done => {
      ...
      alertEl.addEventListener('close.un.alert', event => {
