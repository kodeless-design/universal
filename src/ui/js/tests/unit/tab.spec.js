...
describe('Tab', () => {
  ...
  describe('show', () => {
    it('should activate element by tab id', done => {
      ...
      profileTriggerEl.addEventListener('shown.un.tab', () => {
    ...
    it('should not fire shown when show is prevented', done => {
      ...
      navEl.addEventListener('show.un.tab', ev => {
        ev.preventDefault()
        expectDone()
      })

      navEl.addEventListener('shown.un.tab', () => {
    ...
    it('should not fire shown when tab is already active', done => {
      ...
      triggerActive.addEventListener('shown.un.tab', () => {
        throw new Error('should not trigger shown event')
      })
    ...
    it('should not fire shown when tab is disabled', done => {
      ...
      triggerDisabled.addEventListener('shown.un.tab', () => {
        throw new Error('should not trigger shown event')
      })
    ...
    it('show and shown events should reference correct relatedTarget', done => {
      ...
      secondTabTrigger.addEventListener('show.un.tab', ev => {
        expect(ev.relatedTarget.hash).toEqual('#home')
      })

      secondTabTrigger.addEventListener('shown.un.tab', ev => {
        expect(ev.relatedTarget.hash).toEqual('#home')
    ...
    it('should fire hide and hidden events', done => {
      ...
      triggerList[0].addEventListener('shown.un.tab', () => {
        secondTab.show()
      })

      triggerList[0].addEventListener('hide.un.tab', ev => {
        hideCalled = true
        expect(ev.relatedTarget.hash).toEqual('#profile')
      })

      triggerList[0].addEventListener('hidden.un.tab', ev => {
    ...
    it('should not fire hidden when hide is prevented', done => {
      ...
      triggerList[0].addEventListener('hidden.un.tab', () => {
    ...
    it('should handle removed tabs', done => {
      fixtureEl.innerHTML = [
        ...
        '    <a class="nav-link nav-tab" href="#profile" role="tab" data-un-toggle="tab">',
        '      <button class="btn-close" aria-label="Close"></button>',
        '    </a>',
        '  </li>',
        '  <li class="nav-item" role="presentation">',
        '    <a id="secondNav" class="nav-link nav-tab" href="#buzz" role="tab" data-un-toggle="tab">',
        '      <button class="btn-close" aria-label="Close"></button>',
        '    </a>',
        '  </li>',
        '  <li class="nav-item" role="presentation">',
        '    <a class="nav-link nav-tab" href="#references" role="tab" data-un-toggle="tab">',
      ...
      secondNavEl.addEventListener('shown.un.tab', () => {
  ...
  describe('data-api', () => {
    it('should create dynamically a tab', done => {
      fixtureEl.innerHTML = [
        '<ul class="nav nav-tabs" role="tablist">',
        '  <li class="nav-item" role="presentation"><a href="#home" class="nav-link active" role="tab">Home</a></li>',
        '  <li class="nav-item" role="presentation"><a id="triggerProfile" data-un-toggle="tab" href="#profile" class="nav-link" role="tab">Profile</a></li>',
        '</ul>',
        '<div class="tab-content">',
        '  <div class="tab-pane active" id="home" role="tabpanel"></div>',
        '  <div class="tab-pane" id="profile" role="tabpanel"></div>',
      ...
      secondTabTrigger.addEventListener('shown.un.tab', () => {
    ...
    it('selected tab should deactivate previous selected link in dropdown', () => {
      fixtureEl.innerHTML = [
        ...
        '  <li class="nav-item"><a class="nav-link" href="#home" data-un-toggle="tab">Home</a></li>',
        '  <li class="nav-item"><a class="nav-link" href="#profile" data-un-toggle="tab">Profile</a></li>',
        '  <li class="nav-item dropdown">',
        '    <a class="nav-link dropdown-toggle active" data-un-toggle="dropdown" href="#">Dropdown</a>',
        '    <div class="dropdown-menu">',
        '      <a class="dropdown-item active" href="#dropdown1" id="dropdown1-tab" data-un-toggle="tab">@fat</a>',
        '      <a class="dropdown-item" href="#dropdown2" id="dropdown2-tab" data-un-toggle="tab">@mdo</a>',
        '    </div>',
        '  </li>',
        '</ul>'
      ].join('')
    ...
    it('should handle nested tabs', done => {
      fixtureEl.innerHTML = [
        ...
        '  <a id="tab1" href="#x-tab1" class="nav-link" data-un-toggle="tab" role="tab" aria-controls="x-tab1">Tab 1</a>',
        '  <a href="#x-tab2" class="nav-link active" data-un-toggle="tab" role="tab" aria-controls="x-tab2" aria-selected="true">Tab 2</a>',
        '  <a href="#x-tab3" class="nav-link" data-un-toggle="tab" role="tab" aria-controls="x-tab3">Tab 3</a>',
        '</nav>',
        '<div class="tab-content">',
        '  <div class="tab-pane" id="x-tab1" role="tabpanel">',
        '    <nav class="nav nav-tabs" role="tablist">',
        '      <a href="#nested-tab1" class="nav-link active" data-un-toggle="tab" role="tab" aria-controls="x-tab1" aria-selected="true">Nested Tab 1</a>',
        '      <a id="tabNested2" href="#nested-tab2" class="nav-link" data-un-toggle="tab" role="tab" aria-controls="x-profile">Nested Tab2</a>',
        '    </nav>',
        '    <div class="tab-content">',
      ...
      tabNested2El.addEventListener('shown.un.tab', () => {
        expect(xTab1El.classList.contains('active')).toEqual(true)
        done()
      })

      tab1El.addEventListener('shown.un.tab', () => {
        expect(xTab1El.classList.contains('active')).toEqual(true)
        tabNested2El.click()
      })
    ...
    it('should not remove fade class if no active pane is present', done => {
      fixtureEl.innerHTML = [
        '<ul class="nav nav-tabs" role="tablist">',
        '  <li class="nav-item" role="presentation"><a id="tab-home" href="#home" class="nav-link" data-un-toggle="tab" role="tab">Home</a></li>',
        '  <li class="nav-item" role="presentation"><a id="tab-profile" href="#profile" class="nav-link" data-un-toggle="tab" role="tab">Profile</a></li>',
        '</ul>',
        '<div class="tab-content">',
    ...
    it('should not add show class to tab panes if there is no `.fade` class', done => {
      fixtureEl.innerHTML = [
        '<ul class="nav nav-tabs" role="tablist">',
        '  <li class="nav-item" role="presentation">',
        '    <a class="nav-link nav-tab" href="#home" role="tab" data-un-toggle="tab">Home</a>',
        '  </li>',
        '  <li class="nav-item" role="presentation">',
        '    <a id="secondNav" class="nav-link nav-tab" href="#profile" role="tab" data-un-toggle="tab">Profile</a>',
        '  </li>',
        '</ul>',
        '<div class="tab-content">',
