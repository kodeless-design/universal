...
describe('Manipulator', () => {
  ...
  describe('setDataAttribute', () => {
    it('should set data attribute prefixed with bs', () => {
      ...
      expect(div.getAttribute('data-un-key')).toEqual('value')
    })
    ...
    it('should set data attribute in kebab case', () => {
      ...
      expect(div.getAttribute('data-un-test-key')).toEqual('value')
    })
  })

  describe('removeDataAttribute', () => {
    it('should only remove bs-prefixed data attribute', () => {
      fixtureEl.innerHTML = '<div data-un-key="value" data-key-bs="postfixed" data-key="value"></div>'

      const div = fixtureEl.querySelector('div')

      Manipulator.removeDataAttribute(div, 'key')
      expect(div.getAttribute('data-un-key')).toBeNull()
    ...
    it('should remove data attribute in kebab case', () => {
      fixtureEl.innerHTML = '<div data-un-test-key="value"></div>'

      const div = fixtureEl.querySelector('div')

      Manipulator.removeDataAttribute(div, 'testKey')
      expect(div.getAttribute('data-un-test-key')).toBeNull()
    })
  })
  ...
  describe('getDataAttributes', () => {
    ...
    it('should get only bs-prefixed data attributes without bs namespace', () => {
      fixtureEl.innerHTML = '<div data-un-toggle="tabs" data-un-target="#element" data-another="value" data-target-bs="#element" data-in-bs-out="in-between"></div>'
  ...
  describe('getDataAttribute', () => {
    it('should only get bs-prefixed data attribute', () => {
      fixtureEl.innerHTML = '<div data-un-key="value" data-test-bs="postFixed" data-toggle="tab"></div>'
