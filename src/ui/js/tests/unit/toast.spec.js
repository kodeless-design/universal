...
describe('Toast', () => {
  ...
  describe('constructor', () => {
    ...
    it('should close toast when close element with data-un-dismiss attribute is set', done => {
      fixtureEl.innerHTML = [
        '<div class="toast" data-un-delay="1" data-un-autohide="false" data-un-animation="false">',
        '  <button type="button" class="ms-2 mb-1 btn-close" data-un-dismiss="toast" aria-label="Close"></button>',
        '</div>'
      ].join('')
  ...
  describe('Default', () => {
    it('should expose default setting to allow to override them', () => {
      ...
      fixtureEl.innerHTML = [
        '<div class="toast" data-un-autohide="false" data-un-animation="false">',
        '  <button type="button" class="ms-2 mb-1 btn-close" data-un-dismiss="toast" aria-label="Close"></button>',
        '</div>'
      ].join('')
  ...
  describe('show', () => {
    it('should auto hide', done => {
      fixtureEl.innerHTML = [
        '<div class="toast" data-un-delay="1">',
        '  <div class="toast-body">',
        '    a simple toast',
        '  </div>',
        '</div>'
    ...
    it('should not add fade class', done => {
      fixtureEl.innerHTML = [
        '<div class="toast" data-un-delay="1" data-un-animation="false">',
        '  <div class="toast-body">',
        '    a simple toast',
        '  </div>',
        '</div>'
  ...
  describe('hide', () => {
    it('should allow to hide toast manually', done => {
      fixtureEl.innerHTML = [
        '<div class="toast" data-un-delay="1" data-un-autohide="false">',
        '  <div class="toast-body">',
        '    a simple toast',
        '  </div>',
        '  </div>'
  ...
  describe('dispose', () => {
    ...
    it('should allow to destroy toast and hide it before that', done => {
      fixtureEl.innerHTML = [
        '<div class="toast" data-un-delay="0" data-un-autohide="false">',
        '  <div class="toast-body">',
        '    a simple toast',
        '  </div>',
        '</div>'
