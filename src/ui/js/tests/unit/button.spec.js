...
describe('Button', () => {
  ...
  describe('data-api', () => {
    it('should toggle active class on click', () => {
      fixtureEl.innerHTML = [
        '<button class="btn" data-un-toggle="button">btn</button>',
        '<button class="btn testParent" data-un-toggle="button"><div class="test"></div></button>'
      ].join('')
  ...
  describe('toggle', () => {
    it('should toggle aria-pressed', () => {
      fixtureEl.innerHTML = '<button class="btn" data-un-toggle="button" aria-pressed="false"></button>'
  ...
  describe('dispose', () => {
    it('should dispose a button', () => {
      fixtureEl.innerHTML = '<button class="btn" data-un-toggle="button"></button>'
