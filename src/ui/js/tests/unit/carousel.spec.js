...
describe('Carousel', () => {
  ...
  describe('constructor', () => {
    ...
    it('should allow swiperight and call prev with pointer events', done => {
      ...
      fixtureEl.innerHTML = [
        '<div class="carousel" data-un-interval="false">',
        '  <div class="carousel-inner">',
    ...
    it('should not allow pinch with touch events', done => {
      ...
      fixtureEl.innerHTML = '<div class="carousel" data-un-interval="false"></div>'
  ...
  describe('next', () => {
    ...
    it('should update indicators if present', done => {
      fixtureEl.innerHTML = [
        ...
        '    <li data-un-target="#myCarousel" data-un-slide-to="0" class="active"></li>',
        '    <li id="secondIndicator" data-un-target="#myCarousel" data-un-slide-to="1"></li>',
        '    <li data-un-target="#myCarousel" data-un-slide-to="2"></li>',
        '  </ol>',
        '  <div class="carousel-inner">',
        '    <div class="carousel-item active">item 1</div>',
        '    <div class="carousel-item" data-un-interval="7">item 2</div>',
        '    <div class="carousel-item">item 3</div>',
        '  </div>',
        '</div>'
      ].join('')
  ...
  describe('nextWhenVisible', () => {
    it('should not call next when the page is not visible', () => {
      fixtureEl.innerHTML = [
        ...
        '  <div class="carousel" data-un-interval="false"></div>',
        '</div>'
      ].join('')
  ...
  describe('cycle', () => {
    ...
    it('should get interval from data attribute on the active item element', () => {
      fixtureEl.innerHTML = [
        '<div id="myCarousel" class="carousel slide">',
        '  <div class="carousel-inner">',
        '    <div class="carousel-item active" data-un-interval="7">item 1</div>',
        '    <div id="secondItem" class="carousel-item" data-un-interval="9385">item 2</div>',
        '    <div class="carousel-item">item 3</div>',
        '  </div>',
        '</div>'
      ].join('')
  ...
  describe('data-api', () => {
    it('should init carousels with data-un-ride="carousel" on load', () => {
      fixtureEl.innerHTML = '<div data-un-ride="carousel"></div>'
    ...
    it('should create carousel and go to the next slide on click', done => {
      fixtureEl.innerHTML = [
        ...
        '    <div class="carousel-item">item 3</div>',
        '  </div>',
        '  <div class="carousel-control-prev" data-un-target="#myCarousel" role="button" data-un-slide="prev"></div>',
        '  <div id="next" class="carousel-control-next" data-un-target="#myCarousel" role="button" data-un-slide="next"></div>',
        '</div>'
      ].join('')
    ...
    it('should create carousel and go to the next slide on click with data-un-slide-to', done => {
      fixtureEl.innerHTML = [
        '<div id="myCarousel" class="carousel slide">',
        '  <div class="carousel-inner">',
        '    <div class="carousel-item active">item 1</div>',
        ...
        '    <div class="carousel-item">item 3</div>',
        '  </div>',
        '  <div id="next" data-un-target="#myCarousel" data-un-slide-to="1"></div>',
        '</div>'
      ].join('')
    ...
    it('should do nothing if no selector on click on arrows', () => {
      fixtureEl.innerHTML = [
        ...
        '  </div>',
        '  <div class="carousel-control-prev" data-un-target="#myCarousel" role="button" data-un-slide="prev"></div>',
        '  <div id="next" class="carousel-control-next" role="button" data-un-slide="next"></div>',
        '</div>'
      ].join('')
