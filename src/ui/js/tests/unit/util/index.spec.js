...
describe('Util', () => {
  ...
  describe('getSelectorFromElement', () => {
    it('should get selector from data-un-target', () => {
      fixtureEl.innerHTML = [
        '<div id="test" data-un-target=".target"></div>',
    ...
    it('should get selector from href if no data-un-target set', () => {
      fixtureEl.innerHTML = [
    ...
    it('should get selector from href if data-un-target equal to #', () => {
      fixtureEl.innerHTML = [
        '<a id="test" data-un-target="#" href=".target"></a>',
        '<div class="target"></div>'
      ].join('')
  ...
  describe('getElementFromSelector', () => {
    it('should get element from data-un-target', () => {
      fixtureEl.innerHTML = [
        '<div id="test" data-un-target=".target"></div>',
        '<div class="target"></div>'
      ].join('')
    ...
    it('should get element from href if no data-un-target set', () => {
      fixtureEl.innerHTML = [
        '<a id="test" href=".target"></a>',
        '<div class="target"></div>'
      ].join('')
  ...
  describe('getjQuery', () => {
    ...
    it('should not return jQuery object when present if data-un-no-jquery', () => {
      document.body.setAttribute('data-un-no-jquery', '')

      expect(window.jQuery).toEqual(fakejQuery)
      expect(Util.getjQuery()).toEqual(null)

      document.body.removeAttribute('data-un-no-jquery')
    })
