...
describe('Collapse', () => {
  ...
  describe('constructor', () => {
    it('should allow jquery object in parent config', () => {
      fixtureEl.innerHTML = [
        ...
        '  <div class="item">',
        '    <a data-un-toggle="collapse" href="#">Toggle item</a>',
  ...
  describe('toggle', () => {
    ...
    it('should find collapse children if they have collapse class too not only data-un-parent', done => {
      fixtureEl.innerHTML = [
        '<div class="my-collapse">',
        '  <div class="item">',
        '    <a data-un-toggle="collapse" href="#">Toggle item 1</a>',
        '    <div id="collapse1" class="collapse show">Lorem ipsum 1</div>',
        '  </div>',
        '  <div class="item">',
        '    <a id="triggerCollapse2" data-un-toggle="collapse" href="#">Toggle item 2</a>',
  ...
  describe('data-api', () => {
    it('should show multiple collapsed elements', done => {
      fixtureEl.innerHTML = [
        '<a role="button" data-un-toggle="collapse" class="collapsed" href=".multi"></a>',
    ...
    it('should hide multiple collapsed elements', done => {
      fixtureEl.innerHTML = [
        '<a role="button" data-un-toggle="collapse" href=".multi"></a>',
    ...
    it('should remove "collapsed" class from target when collapse is shown', done => {
      fixtureEl.innerHTML = [
        '<a id="link1" role="button" data-un-toggle="collapse" class="collapsed" href="#" data-un-target="#test1"></a>',
        '<a id="link2" role="button" data-un-toggle="collapse" class="collapsed" href="#" data-un-target="#test1"></a>',
        '<div id="test1"></div>'
      ].join('')
    ...
    it('should add "collapsed" class to target when collapse is hidden', done => {
      fixtureEl.innerHTML = [
        '<a id="link1" role="button" data-un-toggle="collapse" href="#" data-un-target="#test1"></a>',
        '<a id="link2" role="button" data-un-toggle="collapse" href="#" data-un-target="#test1"></a>',
    ...
    it('should allow accordion to use children other than card', done => {
      fixtureEl.innerHTML = [
        '<div id="accordion">',
        '  <div class="item">',
        '    <a id="linkTrigger" data-un-toggle="collapse" href="#collapseOne" aria-expanded="false" aria-controls="collapseOne"></a>',
        '    <div id="collapseOne" class="collapse" role="tabpanel" aria-labelledby="headingThree" data-un-parent="#accordion"></div>',
        '  </div>',
        '  <div class="item">',
        '    <a id="linkTriggerTwo" data-un-toggle="collapse" href="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo"></a>',
        '    <div id="collapseTwo" class="collapse show" role="tabpanel" aria-labelledby="headingTwo" data-un-parent="#accordion"></div>',
        '  </div>',
        '</div>'
      ].join('')
    ...
    it('should not prevent event for input', done => {
      fixtureEl.innerHTML = [
        '<input type="checkbox" data-un-toggle="collapse" data-un-target="#collapsediv1">',
    ...
    it('should allow accordion to target multiple elements', done => {
      fixtureEl.innerHTML = [
        '<div id="accordion">',
        '  <a id="linkTriggerOne" data-un-toggle="collapse" data-un-target=".collapseOne" href="#" aria-expanded="false" aria-controls="collapseOne"></a>',
        '  <a id="linkTriggerTwo" data-un-toggle="collapse" data-un-target=".collapseTwo" href="#" aria-expanded="false" aria-controls="collapseTwo"></a>',
        '  <div id="collapseOneOne" class="collapse collapseOne" role="tabpanel" data-un-parent="#accordion"></div>',
        '  <div id="collapseOneTwo" class="collapse collapseOne" role="tabpanel" data-un-parent="#accordion"></div>',
        '  <div id="collapseTwoOne" class="collapse collapseTwo" role="tabpanel" data-un-parent="#accordion"></div>',
        '  <div id="collapseTwoTwo" class="collapse collapseTwo" role="tabpanel" data-un-parent="#accordion"></div>',
        '</div>'
      ].join('')
    ...
    it('should collapse accordion children but not nested accordion children', done => {
      fixtureEl.innerHTML = [
        ...
        '  <div class="item">',
        '    <a id="linkTrigger" data-un-toggle="collapse" href="#collapseOne" aria-expanded="false" aria-controls="collapseOne"></a>',
        '    <div id="collapseOne" data-un-parent="#accordion" class="collapse" role="tabpanel" aria-labelledby="headingThree">',
        '      <div id="nestedAccordion">',
        '        <div class="item">',
        '          <a id="nestedLinkTrigger" data-un-toggle="collapse" href="#nestedCollapseOne" aria-expanded="false" aria-controls="nestedCollapseOne"></a>',
        '          <div id="nestedCollapseOne" data-un-parent="#nestedAccordion" class="collapse" role="tabpanel" aria-labelledby="headingThree"></div>',
        '        </div>',
        '      </div>',
        '    </div>',
        '  </div>',
        '  <div class="item">',
        '    <a id="linkTriggerTwo" data-un-toggle="collapse" href="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo"></a>',
        '    <div id="collapseTwo" data-un-parent="#accordion" class="collapse show" role="tabpanel" aria-labelledby="headingTwo"></div>',
        '  </div>',
        '</div>'
      ].join('')
    ...
    it('should add "collapsed" class and set aria-expanded to triggers only when all the targeted collapse are hidden', done => {
      fixtureEl.innerHTML = [
        '<a id="trigger1" role="button" data-un-toggle="collapse" href="#test1"></a>',
        '<a id="trigger2" role="button" data-un-toggle="collapse" href="#test2"></a>',
        '<a id="trigger3" role="button" data-un-toggle="collapse" href=".multi"></a>',
