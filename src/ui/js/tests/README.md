## How does Universal's test suite work?

Universal uses [Jasmine](https://jasmine.github.io/). Each plugin has a file dedicated to its tests in `tests/unit/<plugin-name>.spec.js`.
...
- Each test should follow the project's [JavaScript Code Guidelines](https://github.com/kodeless-design/universal/blob/main/.github/CONTRIBUTING.md#js)
