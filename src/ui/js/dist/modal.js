  ...
  class Modal extends BaseComponent {
    ...
    _setScrollbar() {
      if (this._isBodyOverflowing) {
        ...
        SelectorEngine__default['default'].find(SELECTOR_STICKY_CONTENT).forEach(element => {
    ...
    _resetScrollbar() {
      ...
      const padding = Manipulator__default['default'].getDataAttribute(document.body, 'padding-right');
